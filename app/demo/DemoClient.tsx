...
const demoSites: DemoSite[] = [
  ...
  {
    id: "education",
    name: "Institute / Coaching Academy",
    category: "Education",
    icon: <GraduationCap className="w-5 h-5" />,
    iconBg: "from-violet-500 to-indigo-500",
    accentColor: "#7C3AED",
    tagline: "Educational institute website with live course & admission system",
    description:
      "A premier coaching and EdTech institute website with course catalog, faculty credentials, syllabus preview, live demo class bookings, and scholarship test registration.",
    features: [
      "Course Catalog with Category Filters",
      "Interactive Syllabus & Curriculum Modal",
      "Live Demo Class Booking Form",
      "Faculty & Professor Profiles",
      "Scholarship Test (SAT) Registration",
      "Hall of Fame & AIR Ranks Wall",
  ...
  {
    id: "photography",
    name: "Photographer & Cinema Studio",
    category: "Creative",
    icon: <Camera className="w-5 h-5" />,
    iconBg: "from-amber-500 to-orange-500",
    accentColor: "#F59E0B",
    tagline: "Cinematic photography portfolio with package customizer & booking",
    description:
      "A cinematic visual arts studio website with filterable masonry gallery, full-screen image lightbox, interactive shoot package cost builder, and before/after color grade slider.",
    features: [
      "Masonry Portfolio with Lightbox",
      "Interactive Package & Quote Builder",
      "Before & After Color Grade Slider",
      "Shoot Date Availability Reservation",
      "Cinema Gear & Camera Arsenal",
      "Client Testimonials & Press Awards",
      "Category Filters (Weddings, Fashion, Commercial)",
      "Direct WhatsApp Studio Chat",
    ],
    image: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=600&q=75",
    demoUrl: "/demo/photography",
  ...
  },
  {
    ...
    accentColor: "#2563EB",
    tagline: "Enterprise cloud, AI & B2B consulting website with ROI calculator",
    description:
      "A high-impact enterprise solutions website featuring an interactive engineering solutions matrix, ROI & cloud savings calculator, quantifiable case studies, and RFP proposal intake.",
    features: [
      "Strategic Solutions Matrix",
      "Interactive Enterprise ROI Estimator",
      "Quantifiable Case Studies Showcase",
      "Executive Leadership Profiles",
      "Global Delivery Hubs Grid",
      "Confidential RFP Proposal Request",
      "SOC2 / ISO Security Badges",
      "Enterprise SLA Assurances",
    ],
  ...
  },
  {
    ...
    accentColor: "#F59E0B",
    tagline: "5-Star resort & boutique hotel website with room reservation system",
    description:
      "A breathtaking luxury hospitality website with real-time stay date search, ocean villa showcases, instant room reservation modal with price calculation, and resort experiences.",
    features: [
      "Interactive Stay Date Search Bar",
      "Private Pool Villa & Suite Showcase",
      "Live Stay Cost & Night Calculation",
      "Instant Luxury Reservation Modal",
      "Michelin Dining & Wine Experiences",
      "Ayurvedic Wellness Spa Booking",
      "Forbes 5-Star & Michelin Badges",
