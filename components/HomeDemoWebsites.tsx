...
const homeDemos: HomeDemoItem[] = [
  ...
  },
  {
    ...
    accentColor: "#7C3AED",
    tagline: "Premier coaching institute website with course catalog and live trial classes",
    description: "Course discovery with syllabus previews, faculty credentials, live demo class scheduling, and scholarship tests.",
    features: ["Course Catalog", "Free Demo Class Booking", "Faculty Profiles", "Scholarship Test (SAT)"],
  ...
  },
  {
    ...
    accentColor: "#F59E0B",
    tagline: "Cinematic photography portfolio with package builder and date reservations",
    description: "Filterable masonry photo gallery, full-screen lightbox, package cost builder, and before/after color grade slider.",
    features: ["Masonry Lightbox Gallery", "Package Cost Builder", "Before & After Slider", "Date Availability Booking"],
  ...
  },
  {
    ...
    accentColor: "#2563EB",
    tagline: "Enterprise cloud & AI solutions website with interactive ROI calculator",
    description: "Engineering solutions matrix, interactive enterprise ROI & cloud savings estimator, case studies, and RFP intake.",
    features: ["Enterprise Solutions Matrix", "Interactive ROI Estimator", "Case Studies Metrics", "Confidential RFP Modal"],
  ...
  },
  {
    ...
    accentColor: "#F59E0B",
    tagline: "5-Star resort & boutique hotel website with live room reservation system",
    description: "Stay dates search bar, private pool villa showcases, live stay price calculation, and luxury dining reservations.",
    features: ["Stay Date Search Bar", "Private Ocean Villa Showcase", "Live Price Calculation", "Instant Reservation Modal"],
